...
{
    public partial class EncryptClipboard : Form
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public EncryptClipboard()
        {
            InitializeComponent();
        ...
        private void EncryptClipboard_Load(object sender, EventArgs e)
        {
        ...
        private void EncryptClipboard_Resize(object sender, EventArgs e)
        {
        ...
        private void EncryptClipboard_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.ThreadException -= Application_ThreadException;
        }
    }
